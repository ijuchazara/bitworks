...
export function SideNav(): React.JSX.Element {
  ...
  const [selectedProject, setSelectedProject] = React.useState<string>('Agent');
  const projects = ['Agent', 'Agent 1', 'Agent 2'];
  ...
  const handleSelectProject = (project: string) => {
    ...
    handleClose();
    router.push(paths.agent.overview);
  };
  ...
  return (
    ...
    >
      ...
      <Menu
        ...
        open={open}
        onClose={handleClose}
        MenuListProps={{ 'aria-labelledby': 'project-button' }}
        PaperProps={{
          sx: {
